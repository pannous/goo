...
func f1(q *Q, xx []byte) any { // ERROR "live at call to newobject: xx$" "live at entry to f1: xx$"
...
//go:noinline
func f2(d []byte, n int) (odata, res []byte, e any) { // ERROR "live at entry to f2: d$"
	if n > len(d) {
