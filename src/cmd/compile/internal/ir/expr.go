...
func (n *BinaryExpr) SetOp(op Op) {
	...
	case OADD, OADDSTR, OAND, OANDNOT, ODIV, OEQ, OGE, OGT, OLE,
		...
		OCOPY, OCOMPLEX, OTYPEMATCHES, OUNSAFEADD, OUNSAFESLICE, OUNSAFESTRING,
		OMAKEFACE:
		n.op = op
	}
}
...
func (n *CallExpr) SetOp(op Op) {
	...
	case OAPPEND,
		...
		ORECOVER,
		OTRUTHY, OTRUTHYANDOP, OLISTSORTDESC, OLISTPOP, OLISTSHIFT:
		n.op = op
	}
}
...
func (n *UnaryExpr) SetOp(op Op) {
	...
	case OBITNOT, ONEG, ONOT, OPLUS, ORECV,
		OCAP, OCLEAR, OCLOSE, OIMAG, OLEN, ONEW, OPANIC, OREAL, OTYPEOF,
		OCHECKNIL, OCFUNC, OIDATA, OITAB, OSPTR,
		OUNSAFESTRINGDATA, OUNSAFESLICEDATA, OTRUTHY, OLISTSORTDESC, OLISTPOP, OLISTSHIFT:
		n.op = op
	}
}
