...
// OpStringNames provides string representations for Op constants, replacing stringer-generated op_string.go
var OpStringNames = [...]string{
	OXXX:                "XXX",
	ONAME:               "NAME",
	ONONAME:             "NONAME", 
	OTYPE:               "TYPE",
...
func (op Op) String() string {
	if int(op) < len(OpStringNames) && OpStringNames[op] != "" {
		return OpStringNames[op]
	}
