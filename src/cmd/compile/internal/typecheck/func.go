...
func tcCall(n *ir.CallExpr, top int) ir.Node {
	...
	if l.Op() == ir.ONAME && l.(*ir.Name).BuiltinOp != 0 {
		...
		case ir.OCAP, ir.OCLEAR, ir.OCLOSE, ir.OIMAG, ir.OLEN, ir.OPANIC, ir.OREAL, ir.OTYPEOF, ir.OUNSAFESTRINGDATA, ir.OUNSAFESLICEDATA, ir.OTRUTHY, ir.OLISTSORTDESC, ir.OLISTPOP, ir.OLISTSHIFT:
			typecheckargs(n)
			fallthrough
		case ir.ONEW:
